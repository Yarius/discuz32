...
<p class="chart z">Сегодня: <em><?php echo $todayposts;?></em><span class="pipe">|</span>Вчера: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>Сообщений: <em><?php echo $posts;?></em><span class="pipe">|</span>Пользователи : <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['cache']['userstats']['newsetuser']) { ?><span class="pipe">|</span>Приветствуем новичка по имени: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank" class="xi2"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></em><?php } ?></p>
<div class="y">
<?php if(!empty($_G['setting']['pluginhooks']['index_nav_extra'])) echo $_G['setting']['pluginhooks']['index_nav_extra'];?>
<?php if($_G['uid']) { ?><a href="forum.php?mod=guide&amp;view=my" title="Мои сообщения" class="xi2">Мои сообщения</a><?php } if(!empty($_G['setting']['search']['forum']['status'])) { if($_G['uid']) { ?><span class="pipe">|</span><?php } ?><a href="forum.php?mod=guide&amp;view=new" title="Новые сообщения" class="xi2">Новые сообщения</a><?php } ?>
</div>
</div>
<?php } ?>
...
<div class="newimgbox">
<h4><span class="tit_newimg"></span>Последние изображения</h4>
...
<h4><span class="tit_subject"></span>Последние темы</h4>
...
<li><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>"<?php if($thread['highlight']) { ?> <?php echo $thread['highlight'];?><?php } if($_G['setting']['grid']['showtips']) { ?> tip="Название: <strong><?php echo $thread['oldsubject'];?></strong><br/>Автор: <?php echo $thread['author'];?> (<?php echo $thread['dateline'];?>)<br/>Просмотры/Ответить: <?php echo $thread['views'];?>/<?php echo $thread['replies'];?>" onmouseover="showTip(this)"<?php } else { ?> title="<?php echo $thread['oldsubject'];?>"<?php } if($_G['setting']['grid']['targetblank']) { ?> target="_blank"<?php } ?>><?php echo $thread['subject'];?></a></li>
<?php } ?>
         </ul>
         </div>
</td>
...
<div class="replaybox">
<h4><span class="tit_replay"></span>Новые сообщения</h4>
        <ul class="category_newlist">
...
<li><a href="forum.php?mod=redirect&amp;tid=<?php echo $thread['tid'];?>&amp;goto=lastpost#lastpost"<?php if($thread['highlight']) { ?> <?php echo $thread['highlight'];?><?php } if($_G['setting']['grid']['showtips']) { ?>tip="Название: <strong><?php echo $thread['oldsubject'];?></strong><br/>Автор: <?php echo $thread['author'];?> (<?php echo $thread['dateline'];?>)<br/>Просмотры/Ответить: <?php echo $thread['views'];?>/<?php echo $thread['replies'];?>" onmouseover="showTip(this)"<?php } else { ?> title="<?php echo $thread['oldsubject'];?>"<?php } if($_G['setting']['grid']['targetblank']) { ?> target="_blank"<?php } ?>><?php echo $thread['subject'];?></a></li>
<?php } ?>
         </ul>
         </div>
</td>
<td valign="top" class="category_l3">
<div class="hottiebox">
<h4><span class="tit_hottie"></span>Популярное</h4>
        <ul class="category_newlist">
...
<h4><span class="tit_goodtie"></span>Дайджест  темы</h4>
...
<div class="bm">
<div class="bm_h cl">
<h2>Лучшие: <?php echo $_G['setting']['navs']['2']['navname'];?></h2>
</div>
<div class="bm_c cl">
...
<div class="bm_h cl">
<span class="o">
<img id="category_-1_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-1'];?>" title="Показать/Скрыть" alt="Показать/Скрыть" onclick="toggle_collapse('category_-1');" />
</span>
<h2><a href="forum.php?mod=collection&amp;op=my">Мои альбомы</a></h2>
</div>
...
<dd><em>Темы: <?php echo dnumber($colletion['threadnum']); ?></em>, <em>Комментариев: <?php echo dnumber($colletion['commentnum']); ?></em></dd>
<dd>
...
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $colletion['lastpost'];?>&amp;goto=lastpost#lastpost">Посл. сообщение: <?php echo dgmdate($colletion[lastposttime]);?></a>
<?php } } else { ?>
Отсутствуют
<?php } ?>
</dd>
...
<div class="bm_h cl">
<span class="o">
<img id="category_0_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_0'];?>" title="Показать/Скрыть" alt="Показать/Скрыть" onclick="toggle_collapse('category_0');" />
</span>
<h2><a href="home.php?mod=space&amp;do=favorite&amp;type=forum">Избранное</a></h2>
</div>
...
<dt><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="Сегодня"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></dt>
<?php if(empty($forum['redirect'])) { ?><dd><em>Темы: <?php echo dnumber($forum['threads']); ?></em>, <em>Сообщений: <?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
<dd>
<?php if($forum['permission'] == 1) { ?>
Частный форум
<?php } else { if($forum['redirect']) { ?>
<a href="<?php echo $forumurl;?>" class="xi2">Внешние ссылки</a>
...
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost">Посл. сообщение: <?php echo $forum['lastpost']['dateline'];?></a>
<?php } } else { ?>
Отсутствуют
<?php } } ?>
</dd>
...
<td>
<h2><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="Сегодня"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></h2>
<?php if($forum['description']) { ?><p class="xg2"><?php echo $forum['description'];?></p><?php } if($forum['subforums']) { ?><p>Подфорумы: <?php echo $forum['subforums'];?></p><?php } if($forum['moderators']) { ?><p>Модератор: <span class="xi2"><?php echo $forum['moderators'];?></span></p><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]])) echo $_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]];?>
</td>
<td class="fl_i">
...
<div class="bm_h cl">
<span class="o">
<img id="category_<?php echo $cat['fid'];?>_img" src="<?php echo IMGDIR;?>/<?php echo $cat['collapseimg'];?>" title="Показать/Скрыть" alt="Показать/Скрыть" onclick="toggle_collapse('category_<?php echo $cat['fid'];?>');" />
</span>
<?php if($cat['moderators']) { ?><span class="y">Модераторы: <?php echo $cat['moderators'];?></span><?php } $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?><h2><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>"><?php echo $cat['name'];?></a></h2>
</div>
...
<div class="bm_h cl">
<span class="o">
<img id="category_-2_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-2'];?>" title="Показать/Скрыть" alt="Показать/Скрыть" onclick="toggle_collapse('category_-2');" />
</span>
<h2><a href="forum.php?mod=collection">Реккомендовать альбом</a></h2>
</div>
...
<div class="bm_h">
<?php if($detailstatus) { ?>
<span class="o"><a href="forum.php?showoldetails=no#online" title="Показать/Скрыть"><img src="<?php echo IMGDIR;?>/collapsed_no.gif" alt="Показать/Скрыть" /></a></span>
<h3>
<strong><a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">Пользователей</a></strong>
<span class="xs1">- <strong><?php echo $onlinenum;?></strong> Всего онлайн
- <strong><?php echo $membercount;?></strong> Пользователи (<strong><?php echo $invisiblecount;?></strong> невидимых),
<strong><?php echo $guestcount;?></strong> Гостей
- Рекорд одновременного пребывания <strong><?php echo $onlineinfo['0'];?></strong> это было <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } else { if(empty($_G['setting']['sessionclose'])) { ?>
<span class="o"><a href="forum.php?showoldetails=yes#online" title="Показать/Скрыть"><img src="<?php echo IMGDIR;?>/collapsed_yes.gif" alt="Показать/Скрыть" /></a></span>
<?php } ?>
<h3>
<strong>
...
Пользователей
<?php } else { ?>
<a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">Пользователей</a>
<?php } ?>
</strong>
<span class="xs1">- Всего <strong><?php echo $onlinenum;?></strong> Всего онлайн
<?php if($membercount) { ?>- <strong><?php echo $membercount;?></strong> Пользователи ,<strong><?php echo $guestcount;?></strong> Гостей<?php } ?>
- Рекорд одновременного пребывания <strong><?php echo $onlineinfo['0'];?></strong> это было <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } ?>
</div>
...
<dd class="ptm pbm">
<ul class="cl">
<?php if($whosonline) { if(is_array($whosonline)) foreach($whosonline as $key => $online) { ?><li title="Время: <?php echo $online['lastactivity'];?>">
...
<?php } } else { ?>
<li style="width: auto">Гости или невидимки онлайн</li>
<?php } ?>
</ul>
</dd>
<?php } ?>
