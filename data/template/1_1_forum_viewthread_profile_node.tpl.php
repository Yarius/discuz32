...
?><?php
$return = <<<EOF
<div id="g_up{$post['pid']}_menu" class="tip tip_4" style="display: none;"><div class="tip_horn"></div><div class="tip_c">{$post['authortitle']}, Баллы {$post['credits']}, Баллов до нового уровня: {$post['upgradecredit']} Баллы</div></div>
EOF;
?><?php 
return $return;
}
