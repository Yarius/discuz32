...
0
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header.htm', 1414527464, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/footer.htm', 1414527464, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header_common.htm', 1414527464, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/header_qmenu.htm', 1414527464, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
|| checktplrefresh('./source/plugin/mobile/template/mobile.htm', './template/default/common/pubsearchform.htm', 1414527464, 'mobile', './data/template/1_mobile_mobile.tpl.php', './source/plugin/mobile/template', 'mobile')
;?>
...
<div id="shortcut">
<span><a href="javascript:;" id="shortcutcloseid" title="Закрыть">Закрыть</a></span>
вы часто посещаете <?php echo $_G['setting']['bbname'];?> Добавьте ярлык на рабочий стол для большего удобства！
<a href="javascript:;" id="shortcuttip">Отправить <?php echo $_G['setting']['bbname'];?> на рабочий стол</a>
...
<div class="y">
<a id="switchblind" href="javascript:;" onclick="toggleBlind(this)" title="На вторичном доступа" class="switchblind">На вторичном доступа</a>
...
<a href="javascript:;" id="switchwidth" onclick="widthauto(this)" title="<?php if(widthauto()) { ?>Узкий<?php } else { ?>Широкий<?php } ?>" class="switchwidth"><?php if(widthauto()) { ?>Узкий<?php } else { ?>Широкий<?php } ?></a>
<?php } if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">Переключение стилей</a><?php } if(check_diy_perm($topic)) { ?>
<?php echo $diynav;?>
<?php } ?>
</div>
</div>
...
<li><a href="home.php?mod=space&amp;do=pm" id="pm_ntc" style="background-repeat: no-repeat; background-position: 0 50%;"><em class="prompt_news<?php if(empty($_G['member']['newpm'])) { ?>_0<?php } ?>"></em>Сообщения</a></li>
<li><a href="home.php?mod=follow&amp;do=follower"><em class="prompt_follower<?php if(empty($_G['member']['newprompt_num']['follower'])) { ?>_0<?php } ?>"></em>Подписчики<?php if($_G['member']['newprompt_num']['follower']) { ?>(<?php echo $_G['member']['newprompt_num']['follower'];?>)<?php } ?></a></li>
<?php if($_G['member']['newprompt'] && $_G['member']['newprompt_num']['follow']) { ?>
<li><a href="home.php?mod=follow"><em class="prompt_concern"></em>Подписок(<?php echo $_G['member']['newprompt_num']['follow'];?>)</a></li>
...
<li class="ignore_noticeli"><a href="javascript:;" onclick="setcookie('ignore_notice', 1);hideMenu('myprompt_menu')" title="Сообщения и уведомления"><em class="ignore_notice"></em></a></li>
<?php } ?>
</ul>
...
<li><a href="forum.php?mod=guide&amp;view=my">Сообщения</a></li>
<li><a href="home.php?mod=space&amp;do=favorite&amp;view=me">Избранное</a></li>
<li><a href="home.php?mod=space&amp;do=friend">Друзья</a></li>
...
Пожалуйста, <br /><a class="xi2" href="member.php?mod=connect"><strong>дополните информацию об учетной записи</strong></a> или <a href="member.php?mod=connect&amp;ac=bind" class="xi2 xw1"><strong>привяжите существующий аккаунт</strong></a><br />Используйте быстрый переход
</div>
<?php } else { ?>
<div class="ptm pbw hm">
...
<div id="nv">
<a href="javascript:;" id="qmenu" onmouseover="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu(<?php echo $_G['fid'];?>);})">Меню</a>
...
$slist[forumfid] = <<<EOF
<li><a href="javascript:;" rel="curforum" fid="{$_G['fid']}" >Поиск</a></li>
EOF;
?><?php } if($_G['setting']['portalstatus'] && $_G['setting']['search']['portal']['status'] && ($_G['group']['allowsearch'] & 1 || $_G['adminid'] == 1)) { ?><?php
$slist[portal] = <<<EOF
<li><a href="javascript:;" rel="article">Статьи</a></li>
EOF;
?><?php } if($_G['setting']['search']['forum']['status'] && ($_G['group']['allowsearch'] & 2 || $_G['adminid'] == 1)) { ?><?php
$slist[forum] = <<<EOF
<li><a href="javascript:;" rel="forum" class="curtype">Темы</a></li>
EOF;
?><?php } if(helper_access::check_module('blog') && $_G['setting']['search']['blog']['status'] && ($_G['group']['allowsearch'] & 4 || $_G['adminid'] == 1)) { ?><?php
$slist[blog] = <<<EOF
<li><a href="javascript:;" rel="blog">Блоги</a></li>
EOF;
?><?php } if(helper_access::check_module('album') && $_G['setting']['search']['album']['status'] && ($_G['group']['allowsearch'] & 8 || $_G['adminid'] == 1)) { ?><?php
$slist[album] = <<<EOF
<li><a href="javascript:;" rel="album">Фото</a></li>
EOF;
...
?><?php } ?><?php
$slist[user] = <<<EOF
<li><a href="javascript:;" rel="user">Люди</a></li>
EOF;
?>
...
<td class="scbar_txt_td"><input type="text" name="srchtxt" id="scbar_txt" value="Поиск по сайту" autocomplete="off" x-webkit-speech speech /></td>
...
<strong class="xw1">Популярное: </strong><?php if(is_array($_G['setting']['srchhotkeywords'])) foreach($_G['setting']['srchhotkeywords'] as $val) { if($val=trim($val)) { $valenc=rawurlencode($val);?><?php
...
<?php } else { if($_G['adminid'] == 1 && !$_G['cookie']['mobiletips']) { ?>
  <div class="wrap">
<div id="admintips" class="tips"><span class="y"><a href="javascript:hiddentips();" class="close">Закрыть</a></span>尊敬的站长，您可以在Discuz!程序根目录上传"mobile.png"图片(尺寸178x178)，以确保论坛客户端能成功获得到论坛的logo</div>
    <?php } ?>
<div class="content">
<ul class="platform">
...
<div class="bm">
<div class="bm_h cl">
<a href="javascript:;" onclick="setcookie('nofocus_<?php echo $_G['basescript'];?>', 1, <?php echo $_G['cache']['focus']['cookie'];?>*3600);$('sitefocus').style.display='none'" class="y" title="Закрыть">Закрыть</a>
<h2>
<?php if($_G['cache']['focus']['title']) { ?><?php echo $_G['cache']['focus']['title'];?><?php } else { ?>Рекомендации вебмастера<?php } ?>
<span id="focus_ctrl" class="fctrl"><img src="<?php echo IMGDIR;?>/pic_nv_prev.gif" alt="Назад" title="Назад" id="focusprev" class="cur1" onclick="showfocus('prev');" /> <em><span id="focuscur"></span>/<?php echo $focusnum;?></em> <img src="<?php echo IMGDIR;?>/pic_nv_next.gif" alt="Вперед" title="Вперед" id="focusnext" class="cur1" onclick="showfocus('next')" /></span>
</h2>
</div>
...
<p class="ptn cl"><a href="<?php echo $_G['cache']['focus']['data'][$id]['url'];?>" class="xi2 y" target="_blank">Обзор &raquo;</a></p>
</div><?php $focusi ++;?><?php } ?>
<script type="text/javascript">
...
h5n.shownotification('pm', '<?php echo $_G['siteurl'];?>home.php?mod=space&do=pm', '<?php echo avatar($_G[uid],small,true);?>', 'Новое сообщение', 'Новое сообщение, посмотреть его!');
<?php } if($_G['member']['newprompt'] && $_GET['do'] != 'notice') { if(is_array($_G['member']['category_num'])) foreach($_G['member']['category_num'] as $key => $val) { $noticetitle = lang('template', 'notice_'.$key);?>h5n.shownotification('notice_<?php echo $key;?>', '<?php echo $_G['siteurl'];?>home.php?mod=space&do=notice&view=<?php echo $key;?>', '<?php echo avatar($_G[uid],small,true);?>', '<?php echo $noticetitle;?> (<?php echo $val;?>)', 'Новое уведомление, посмотрите его!');
<?php } } ?>
}
</script>
...
<span><a href="forum.php?mod=post&amp;action=reply&amp;fid=<?php echo $_G['fid'];?>&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;page=<?php echo $page;?><?php if($_GET['from']) { ?>&amp;from=<?php echo $_GET['from'];?><?php } ?>" onclick="showWindow('reply', this.href)" class="replyfast" title="Быстрый ответ"><b>Быстрый ответ</b></a></span>
<?php } ?>
...
<a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" hidefocus="true" class="returnlist" title="Назад к списку"><b>Назад к списку</b></a>
<?php } else { ?>
